...
curl -H "Authorization: Bearer YOUR_TOKEN" \
  http://192.168.1.50:5000/api/growth-notifications
```

#### Număr notificări necitite
```bash
curl -H "Authorization: Bearer YOUR_TOKEN" \
  http://192.168.1.50:5000/api/growth-notifications/unread-count
```
...
curl -X PUT \
  ...
  http://192.168.1.50:5000/api/growth-notifications/NOTIFICATION_ID/read
```
...
curl -X PUT \
  -H "Authorization: Bearer YOUR_TOKEN" \
  http://192.168.1.50:5000/api/growth-notifications/NOTIFICATION_ID/complete
```
